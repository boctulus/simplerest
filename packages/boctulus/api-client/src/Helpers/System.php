...
class System
{
    ...
    */
    ...
    /*
        Ejecuta un commando de PowerShell

        Feature: Soluiciona problemas con comillas 
        al ejecutarlo en archivo temporal
    ...
    */
    static function ps_exec($command, &$exit_code = null) {
        // Generar nombre único para el archivo temporal
        $tmp_dir = sys_get_temp_dir();
        $tmp_file = $tmp_dir . DIRECTORY_SEPARATOR . uniqid('ps_') . '.ps1';
        
        // Escribir el comando en el archivo .ps1
        file_put_contents($tmp_file, $command);
        
        // Construir el comando para ejecutar PowerShell
        $ps_command = sprintf(
        ...
        $output = [];
        $exit_code = 0;
        exec($ps_command, $output, $exit_code);
