...
use App\Models\OrgComunal;
use App\Http\Resources\OrgComunalResource;

class OrgComunalController extends Controller
{
    ...
    {
        return OrgComunalResource::collection( OrgComunal::paginate() );
    }
    ...
    public function store(Request $request)
    {
        ...
        return new OrgComunalResource( OrgComunal::create($validated) );
    }

    /**
     * Display the specified resource.
     *
     * @param  \App\Models\OrgComunal  $obj
     * @return \Illuminate\Http\Response
     */
    public function show(OrgComunal $obj)
    {
        return new OrgComunalResource($obj);
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(OrgComunal $obj)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, OrgComunal $obj)
    {
        try {
            $validated = $request->validate(static::$rules);
        } catch (\Exception $e){
