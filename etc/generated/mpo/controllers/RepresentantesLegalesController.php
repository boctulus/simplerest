...
use App\Http\Resources\RepresentantesLegalesResource;
...
class RepresentantesLegalesController extends Controller
{
    ...
    {
        return RepresentantesLegalesResource::collection( RepresentantesLegales::paginate() );
    }
    ...
    public function store(Request $request)
    {
        ...
        return new RepresentantesLegalesResource( RepresentantesLegales::create($validated) );
    }

    /**
     * Display the specified resource.
     *
     * @param  \App\Models\RepresentantesLegales  $obj
     * @return \Illuminate\Http\Response
     */
    public function show(RepresentantesLegales $obj)
    {
        return new RepresentantesLegalesResource($obj);
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(RepresentantesLegales $obj)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, RepresentantesLegales $obj)
    {
        try {
            $validated = $request->validate(static::$rules);
        } catch (\Exception $e){
    ...
    {
        try {
            $affected_rows = (new \App\Models\RepresentantesLegales())
            ->where('id', $id)
            ->delete();
        } catch (\Exception $e){
            return new Response([
