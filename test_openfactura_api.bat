...
echo -------------------------------
curl -X GET "!BASE_URL!/api/v1/openfactura/health" ^
...
echo ------------------------------------------------------------
curl -X POST "!BASE_URL!/api/v1/openfactura/dte/emit" ^
  -H "Content-Type: application/json" ^
  -H "Accept: application/json" ^
  -d "{\"dteData\": {}}" ^
  --verbose
...
echo ------------------------------------------------------------
curl -X GET "!BASE_URL!/api/v1/openfactura/dte/status/invalid_token" ^
  -H "Content-Type: application/json" ^
  -H "Accept: application/json" ^
  --verbose
echo.
...
echo -----------------------------------------------------------------------
curl -X POST "!BASE_URL!/api/v1/openfactura/dte/anular-guia" ^
  -H "Content-Type: application/json" ^
  -H "Accept: application/json" ^
...
echo ------------------------------------------------------------
curl -X POST "!BASE_URL!/api/v1/openfactura/dte/anular" ^
  -H "Content-Type: application/json" ^
  -H "Accept: application/json" ^
  -d "{\"dteData\": {}}" ^
  --verbose
...
echo --------------------------------------------------------
curl -X GET "!BASE_URL!/api/v1/openfactura/taxpayer/12345678-9" ^
  -H "Content-Type: application/json" ^
  -H "Accept: application/json" ^
  --verbose
echo.
...
echo ------------------------------------
curl -X GET "!BASE_URL!/api/v1/openfactura/organization" ^
  -H "Content-Type: application/json" ^
  -H "Accept: application/json" ^
  --verbose
echo.
...
echo --------------------------------------------------------------------
curl -X GET "!BASE_URL!/api/v1/openfactura/sales-registry/2025/01" ^
  -H "Content-Type: application/json" ^
  -H "Accept: application/json" ^
  --verbose
echo.
...
echo -----------------------------------------------------------------------
curl -X GET "!BASE_URL!/api/v1/openfactura/purchase-registry/2025/01" ^
  -H "Content-Type: application/json" ^
  -H "Accept: application/json" ^
  --verbose
echo.
...
echo -----------------------------------------------------------------------
curl -X GET "!BASE_URL!/api/v1/openfactura/document/12345678-9/33/12345" ^
  -H "Content-Type: application/json" ^
  -H "Accept: application/json" ^
  --verbose
echo.
