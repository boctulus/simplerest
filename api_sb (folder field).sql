...
--
-- Host: localhost
-- Generation Time: Oct 07, 2019 at 05:54 PM
...
INSERT INTO `folders` (`id`, `resource_table`, `field`, `value`, `belongs_to`) VALUES
(5, 'products', 'workspace', 'lista', 87),
(4, 'products', 'workspace', 'lista publica', 90),
(8, 'products', 'workspace', 'lista10', 90),
(6, 'products', 'workspace', 'lista2', 90),
(1, 'products', 'workspace', 'mylist', 1),
(2, 'products', 'workspace', 'otralista', 72),
(3, 'products', 'workspace', 'super', 89);
...
ALTER TABLE `folders`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `resource_table` (`resource_table`,`field`,`value`,`belongs_to`),
