 ...
 *
 * Compiles the HTTP benchmark and internal analysis into a Markdown report.
 *
 * Usage:
 *   php scripts/perf_benchmark.php       # first run the benchmarks
 *   php scripts/perf_report.php          # generates the report
 */
...
// Write report
$reportPath = __DIR__ . '/../reports/performance-benchmark-report.md';
file_put_contents($reportPath, $report);

echo "Report generated: $reportPath\n";
echo "Total size: " . strlen($report) . " bytes\n";
