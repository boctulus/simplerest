...
<div class="row mt-5">
    ...
    <div class="col-md-5 mx-auto my-3" id="my_search">
        ...
        <br/><h3 class="my-3">Quotes</h3><div class="card mb-4"><div class="card-header">Quote</div> <div class="card-body"><blockquote class="quote-primary mb-0"><p>A well-known quote, contained in a blockquote element.</p><footer class="blockquote-footer">Someone famous in <cite title="Source Title">Source Title</cite></footer></blockquote></div> <div class="card-footer">Some footer</div></div><div class="card mb-4"><div class="card-header">Quote</div> <div class="card-body"><blockquote class="quote-secondary mb-0" color="secondary"><p>A well-known quote, contained in a blockquote element.</p><footer class="blockquote-footer">Someone famous in <cite title="Source Title">Source Title</cite></footer></blockquote></div> <div class="card-footer">Some footer</div></div><h3 class="my-3">Cards</h3><div class="card mb-4"><div class="card-header"><h5 class="card-title">Some title</h5></div> <div class="card-body"><h6 class="card-subtitle mb-2" textMuted="">Some subtitle</h6></div> </div><div class="card my-3 text-white bg-primary" style="width: 18rem;"><div class="card-header"><h5 class="card-title">Some title</h5></div> <div class="card-body"><p class="card-text">Some quick example text to build on the card title and make up the bulk of the cards content.</p> <input class="btn btn-info text-white" type="button" value="Go somewhere"></input></div> </div><div class="card my-3" style="width: 18rem;"><div class="card-header"><h5 class="card-title">Some title</h5></div> <img class="card-img-top" src="http://simplerest.lan/public/assets/img/mail.png" 0=""></img> <div class="card-body"><p class="card-text">Some quick example text to build on the card title and make up the bulk of the cards content.</p> <input class="btn btn-primary" type="button" value="Go somewhere"></input></div> </div><div class="card my-3" style="width: 18rem;" placeholder=""><div class="card-header"><h5 class="card-title">Some title</h5></div> <img class="card-img-top" src="http://simplerest.lan/public/assets/img/mail.png" 0=""></img> <div class="card-body"><h6 class="card-subtitle placeholder-glow"><span class="placeholder col-9 bg-warning"></span></h6> <p class="card-text placeholder-glow">
            ...
            </p> <input class="btn btn-primary disabled placeholder w-50" type="button" placeholder="" value=""></input></div> </div>    <style>
...
.flip-card-back {
  ...
  transform: rotateY(180deg);
    ...
    <div class="card my-3 flip-card"> <div class="flip-card-inner"><div class="flip-card-front bg-transparent"><h3 class="bg-primary py-2">Tienes un correo</h3> <img src="http://simplerest.lan/public/assets/img/mail.png" style="max-width: 65%;"></img></div> <div class="flip-card-back py-2"><h3>Some title</h3> <p class="card-text">Some quick example text to build on the card title and make up the bulk of the cards content.</p> <input class="btn btn-primary" type="button" value="Go somewhere"></input></div></div>  </div><h3 class="my-3">Badges</h3><div class="badge mb-3 me-3 rounded-pill bg-success">barato</div><button class="rounded position-relative btn-primary btn" type="button">Correos <div class="badge position-absolute top-0 start-100 translate-middle rounded-pill bg-danger">99+</div></button><h3 class="my-3">Buttons</h3><div class="btn-group my-3" role="group"><input class="btn btn-info rounded-pill" type="button" value="Un botón"></input> <input class="btn btn-lg btn-warning form-control-lg rounded-pill" type="button" large="" value="Otro botón"></input> <input class="btn btn-sm btn-info form-control-sm rounded-pill mx-3" type="button" small="" value="Peque"></input></div><div class="btn-group my-3" role="group"><button type="button" class="btn btn-lg bg-success">Un botón</button> <button type="button" class="btn btn-lg bg-success bg-gradient">Un botón</button></div><button type="button" class="btn btn-lg bg-danger">Un botón</button><button type="button" class="btn btn-lg btn-flat bg-warning">Un botón</button><div class="btn-group-sm mx-3" role="group" aria-label="Basic example"><button type="button" class="btn btn-danger rounded-pill">A</button><button type="button" class="btn btn-outline-success rounded-pill" outline="">B</button></div><div class="btn-group mx-3" role="group" aria-label="Basic example"><button type="button" class="btn btn-danger rounded-pill">C</button><button type="button" class="btn btn-outline-success rounded-pill" outline="">D</button></div><div class="btn-group-lg mx-3" role="group" aria-label="Basic example"><button type="button" class="btn btn-danger rounded-pill">E</button><button type="button" class="btn btn-outline-success rounded-pill" outline="">F</button></div><button type="button" class="btn btn-primary btn-block mt-3">.btn-block</button><button type="button" class="btn btn-outline-primary btn-block" outline="">.btn-block</button><button type="button" class="btn btn-primary btn-block"><i class="fa fa-bell"></i> .btn-block</button><button type="button" class="btn btn-outline-primary btn-block" outline=""><i class="fa fa-bell"></i> .btn-block</button><a class="btn btn-app  mt-3" href="#edit"><i class="fas fa-edit"></i> Edit</a></a><a class="btn btn-app  mt-3 bg-danger" href="#edit" badgeQty="5"><span class="bg-warning badge">5</span><i class="fas fa-edit"></i> Edit</a></a><br/><div class="btn-group my-3" role="group"><input class="btn btn-info rounded-pill" type="button" value="Un botón"></input> <input class="btn btn-lg btn-warning form-control-lg rounded-pill" type="button" large="" value="Otro botón"></input> <input class="btn btn-sm btn-info form-control-sm rounded-pill mx-3" type="button" small="" value="Peque"></input></div><h3 class="my-3">inputGroup</h3><div class="input-group mb-3"><div class="input-group-prepend"><button type="button" class="btn btn-danger">Action</button></div><input class="form-control" type="text"></input></div><div class="input-group mb-3"><input class="form-control" type="text"></input><div class="input-group-append"><button type="button" class="btn btn-info">Go!</button></div></div><div class="input-group mb-3"><div class="input-group-prepend"><button type="button" class="btn btn-danger">Action</button></div><input class="form-control" type="text"></input><div class="input-group-append"><button type="button" class="btn btn-info">Go!</button></div></div><div class="input-group mb-3"><div class="input-group-prepend"><button type="button" class="btn btn-danger">Action</button></div><div class="input-group-prepend"><button type="button" class="btn btn-warning">Other action</button></div><input class="form-control" type="text"></input><div class="input-group-append"><button type="button" class="btn btn-info">Go!</button></div></div>    <style>
    .ms-n5 {
	margin-left: -40px;
}    </style>
    <div class="input-group"><input class="form-control" type="text" placeholder="Search"></input><div class="input-group-append"><button type="button" class="btn btn-info ms-n5"><i class="fa fa-search"></i> </button></div></div><h3 class="my-3">buttonGroup</h3><div class="btn-group my-3" role="group"><button type="button" class="btn btn-info">Left</button> <button type="button" class="btn btn-info">Middle</button> <button type="button" class="btn btn-info">Right</button></div><p></p><div class="btn-group-vertical" role="group"><button type="button" class="btn btn-warning">Top</button> <button type="button" class="btn btn-warning">Middle</button> <button type="button" class="btn btn-warning">Bottom</button></div><h3 class="my-3">buttonToolbar</h3><div class="btn-toolbar my-3" role="toolbar"><div class="btn-group mx-3" role="group" aria-label="Basic example"><button type="button" class="btn btn-danger rounded-pill">Botón rojo</button><button type="button" class="btn btn-outline-success rounded-pill" outline="">Botón verde</button></div> <div class="btn-group mx-3" role="group" aria-label="Another group"><button type="button" class="btn btn-info rounded-pill">Botón azul</button><button type="button" class="btn btn-outline-warning rounded-pill" outline="">Botón amarillo</button></div></div><h3 class="mb-3">Collapse</h3><p><a class="btn btn-primary  me-1" data-bs-toggle="collapse" role="button" href="#collapseExample">Link with href</a><button data-bs-toggle="collapse" type="button" class="btn btn-primary" data-bs-target="#collapseExample">Button with data-bs-target</button></p><div class="collapse" id="collapseExample"><div class="card-body">Some placeholder content for the collapse component. This panel is hidden by default but revealed when the user activates the relevant trigger.</div></div><h3 class="mb-3">Alert</h3><div class="alert alert-primary alert-dismissible fade show  alert-success" role="alert" title="Perfecto!" success=""><button type="button" class="close" data-bs-dismiss="alert" aria-label="Close">×</button><h5><i class="icon fas fa-check"></i> Perfecto! </h5>OK</div><div class="alert alert-primary alert-dismissible fade show  alert-warning" role="alert" title="Cuidado!" warning=""><button type="button" class="close" data-bs-dismiss="alert" aria-label="Close">×</button><h5><i class="icon fas fa-exclamation-triangle"></i> Cuidado! </h5>Algo para tener en cuenta.</div><div class="alert alert-primary alert-dismissible fade show  alert-danger" role="alert" title="Error!" danger=""><button type="button" class="close" data-bs-dismiss="alert" aria-label="Close">×</button><h5><i class="icon fas fa-ban"></i> Error! </h5>Algo salió mal.</div><div class="alert alert-primary alert-dismissible fade show  alert-danger" role="alert" danger=""><button type="button" class="close" data-bs-dismiss="alert" aria-label="Close">×</button>Algo salió mal.</div><div 0="warning" 1="dismissible" class="alert alert-primary alert-dismissible fade show" role="alert" 2="warning" 3="dismissible"><button type="button" class="close" data-bs-dismiss="alert" aria-label="Close">×</button>Some content</div><h2 class="my-3">Callouts</h2><div class="callout callout-danger" title="Some title"><h5>Some title</h5><p>There is a problem that we need to fix. A wonderful serenity has taken possession of my entire
        soul, like these sweet mornings of spring which I enjoy with my whole heart.</p></div><h3 class="mb-3">Select</h3><select class="my-3 form-select" placeholder="Su sexo" name="sexo" id="sexo"><option >Su sexo</option> <option value="1" selected>varon</option> <option value="2" >mujer</option></select><select placeholder="Tu comida favorita" class="form-select my-3" name="comidas" multiple="" id="comidas"><optgroup label="Asado" class="form-label"><option hidden="hidden" selected="selected">Tu comida favorita</option> <option value="pasta" >Pasta</option> <option value="pizza" >Pizza</option> <option value="asado" >Asado</option></optgroup><optgroup label="Frutilla" class="form-label"><option hidden="hidden" selected="selected">Tu comida favorita</option> <option value="banana" >Banana</option> <option value="frutilla" >Frutilla</option></optgroup></select><h3 class="mb-3">DataList</h3><label for="occupation" class="form-label">Ocupación</label><input placeholder="Escriba aquí" class="form-control" list="datalistOptions" id="occupation"></input><dataList id="datalistOptions"><option value="programador"/> <option value="software engenierer"/></dataList><hr style="color:cyan; height: 10px;"></hr><p>Hola mundo cruel</p><h3 class="mb-3">Opacity (text utility)</h3><div class="text-primary mt-3">Some content</div><div class="text-primary mb-3" style="--bs-text-opacity: 0.5;" opacity="0.5">Some content but with opacity of 50%</div><h3 class="mb-3">inputColor</h3><input class="form-control form-control-color" type="color" id="my_color" name="my_color" value="#563d7c"><label for="c1" class="form-label" name="my_color" value="#563d7c" id="my_color">Color</label></input><h3 class="mb-3">inputGroup implementado con div</h3><div class="input-group mb-3"><span class="input-group-text" id="basic-addon">@</span> <input class="form-control" type="text" name="nombre" placeholder="Username" id="nombre"></input></div><h3 class="mb-3">inputText</h3><input class="form-control disabled" type="text" name="iq" placeholder="IQ" id="iq"  disabled></input><h3 class="mb-3 mt-3">Ion Sliders</h3>    <style>
...
.mask {
    ...
    <div class="bg-image rounded" text="Puedes verme?" style="font-size:130%;"><img src="http://simplerest.lan/public/assets/img/slide-3.jpeg" class="w-100" alt="Louvre Museum"></img>
        ...
        </div></div><br></br><span class="my-3 me-1" style="color: red">Hello bella Isabel</span> ~ <a class="mb-3 text-success" href="http://www.solucionbinaria.com">SolucionBinaria .com</a><h3 class="mb-3 mt-5">Ribbons</h3>
        <div class="card card-primary">
              ...
              <div class="row">
                    ...
                    <div class="position-relative bg-gray" style="height: 100px"> <div class="ribbon-wrapper"><div class="bg-primary ribbon">Ribbon</div></div> Ribbon Default <br />
                        <small>.ribbon-wrapper.ribbon-lg .ribbon</small></div>
                    <div class="position-relative mt-3 bg-gray" style="min-height: 300px"><img src="http://simplerest.lan/public/assets/img/photo2.png" class="img-fluid py-3"></img> <div class="ribbon-wrapper ribbon-xl" textSize="xl"><div class="bg-danger text-xl ribbon">Ribbon</div></div> Ribbon Default <br />
                        <small>.ribbon-wrapper.ribbon-lg .ribbon</small></div>                  
              </div>
        ...
        <hr></hr><h2 class="mb-3">Widgets</h2><h3 class="mb-3">Milestone / Timeline</h3>    <style>
