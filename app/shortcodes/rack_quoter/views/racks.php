          ...
          <div class="row">
            <div class="col-md-12 col-xs-12 text-center">
              <div class="-content">
                ...
                <div class="main-img"><img src="http://woo7.lan/api/drawing/preview/?ItemKey=96x36x96&Condition=new&Design=3&Levels=2&PlaceWidth=600&PlaceLength=120&Aisle=100&ItemTypeKey=pallet-rack&ItemGroupKey=&UseWireDecking=false&UsePalletSupport=false&maxheight=0">
                </div><!---->
                <div><!---->
                    ...
                    <div aisle="controller.Model.Aisle">
                      ...
                      <div class="clearfix aisle-wrapper">
                        <div class="row -item-inline">
                          ...
                          <div class="input-group col-md-3 col-xs-3 text-center" style="margin: auto; margin-top: 15px; display: none;">
