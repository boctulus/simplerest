...
.dijitTooltip{display:none !important;}
	...
	@media (max-width: 620px){
		...
		<div class="wrapper rounded6" id="templateContainer">
		    <h1 class="masthead"><a href="http://www.diagnosticojournal.coom"><img src="https://mcusercontent.com/a981b45880eea70b899f8ed96/images/cd77662d-0be1-4dde-aa6d-797aa348cef1.jpg" alt="" border="0" style="border:0px  ; border-width: 0px; height: 344px; width: 1252px; margin: 0; padding: 0;" width="1252" height="344"></a></h1>

		    <div id="templateBody" class="bodyContent rounded6">
        <div id="subscribeFormWelcome"><div style="text-align: center;">Suscripci&oacute;n al newsletter de&nbsp;Diagn&oacute;stico Journal</div>
</div>
<div class="indicates-required"><span class="asterisk">*</span> indica que es obligatorio</div>



<form action="https://diagnosticojournal.us8.list-manage.com/subscribe/post" method="POST">
    <input type="hidden" name="u" value="a981b45880eea70b899f8ed96">
    <input type="hidden" name="id" value="363f983b38">
    ...
    <div id="mergeTable" class="mergeTable">
        ...
        <div class="mergeRow dojoDndItem mergeRow-text" id="mergeRow-1">
            <label for="MERGE1">Nombre <span class="req asterisk">*</span></label>
            <div class="field-group">
        ...
        <div class="mergeRow dojoDndItem mergeRow-text" id="mergeRow-2">
            <label for="MERGE2">Apellido <span class="req asterisk">*</span></label>
            <div class="field-group">
        ...
        <div class="mergeRow dojoDndItem mergeRow-text" id="mergeRow-4">
            <label for="MERGE4">Institución <span class="req asterisk">*</span></label>
            <div class="field-group">
        ...
        <div class="mergeRow dojoDndItem mergeRow-text" id="mergeRow-5">
            <label for="MERGE5">País <span class="req asterisk">*</span></label>
            <div class="field-group">
        ...
        <div class="mergeRow dojoDndItem mergeRow-text" id="mergeRow-3">
            <label for="MERGE3">Teléfono</label>
            <div class="field-group">
    ...
    <input type="hidden" name="ht" value="8c2e8a1dad46aa8b423a23eda3a979c7aa887fea:MTY1NTk1NzgzMS4zOTM3">
