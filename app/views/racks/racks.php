<div class="row">
  <div class="main-form">
    ...
    <div class="tab-content">
      <div id="step-01" class="active tab-pane clearfix" data-ng-show="controller.selectedStep === controller.steps.ItemStep" style="">
        ...
        <div class="-item -img">
          <!---->
          <img data-ng-src="/assets/img/images/NewPalletRack.png" alt="" data-ng-if="!!controller.Model.SelectedItem" src="/assets/img/images/NewPalletRack.png" class="" style="">
          <!---->
          <p class="-img-caption" lang-bind="controller.fields.palletrack.MasterImgTitle">4 Beam Levels in diagram</p>
        </div>
      </div>
      <div id="step-02" class="active tab-pane clearfix ng-hide" data-ng-show="controller.selectedStep === controller.steps.DeckingStep" style="">
        <div class="clearfix row">
          <div class="-item-tab-half col-md-6">
            ...
            <div class="-img" data-ng-show="!controller.Model.UseSupport">
              <img src="/assets/img/tab2-img01.png" alt="">
            </div>
          </div>
          <div class="-item-tab-half col-md-6">
            <div class="-caption ng-hide" data-ng-show="!controller.Model.UseWireDeck" style="">
            ...
            <div class="-img ng-hide" data-ng-show="!controller.Model.UseWireDeck" style="">
              <img src="/assets/img/tab2-img02.png" alt="">
            </div>
          </div>
        </div>
      </div>
      <div id="step-03" class="active clearfix tab-pane text-center ng-hide" data-ng-show="controller.selectedStep === controller.steps.AreaStep" style="">
        <!---->
        <!---->
        <!---->
        ...
        <div class="-img centered">
          <!---->
          <img data-ng-src="/assets/img/space/multiple.png" alt="" data-ng-if="controller.designTypes.multiple.Name === controller._design" src="/assets/img/space/multiple.png">
          <!---->
          <!---->
          <!---->
        </div>
  ...
  <div class="main-form-btn-group">
    <button id="tabPrev" class="btn btn-primary -prev no-animate ng-hide" data-ng-click="controller.backStep()" data-ng-show="controller.selectedStep > 0" style="">
    ...
    <button id="tabNext" class="btn btn-primary -next" data-ng-click="controller.nextStep()" data-ng-disabled="controller.selectedStep === controller.steps.AreaStep &amp;&amp; areaForm.$invalid">
      ...
      <span lang-bind="controller.fields.common.ViewDrawing" data-ng-show="controller.isLastStep()" class="ng-hide">View Drawing</span>
