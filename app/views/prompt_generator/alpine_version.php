        ...
        function promptGenerator() {
            return {
                ...
                init() {
                    ...
                    this.$watch('filePaths', () => this.saveFormToLocalStorage(), { deep: true });
                },
                ...
                generatePrompt() {
                    ...
                    this.filePaths
                        .filter(file => !file.disabled && file.path.trim())
                        .forEach(file => {
                    ...
                    // En una implementación real, aquí haríamos la petición AJAX
                },
