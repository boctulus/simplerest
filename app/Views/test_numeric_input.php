...
<fieldset>
    ...
    <input id="input12" name="quantity" type="number" step="0.76" min="2.28">
</fieldset>

<script>
    // Uso:
    const properInput_11 = new ProperInput();
  
    properInput_11.setSelector('input#input11');
    properInput_11.init();


    const properInput_12 = new ProperInput();

    properInput_12.setSelector('input[name="quantity"]');
    // properInput_12.setSelector('input#input12');
    // properInput_12.setRoundFunction(Math.round);
    properInput_12.enforceStep(false);
    properInput_12.init();
