...
<script>
    class SocialProfileCard extends HTMLElement {
        ...
        render() {
            ...
            shadow.querySelector('.subtitle').textContent = this.getAttribute('subtitle') || '';
            shadow.querySelector('.stats').textContent = this.getAttribute('stats') || '';
            shadow.querySelector('.rating').textContent = this.getAttribute('rating') || '';

            const profileImage = shadow.querySelector('.profile-image');
            profileImage.src = this.getAttribute('image') || '';

            // Renderizar íconos sociales solo si hay al menos una red social
            const socialIconsContainer = shadow.querySelector('.social-icons');
            socialIconsContainer.innerHTML = '';

            let hasSocialLinks = false;

            socialLinks.forEach(({ attr, icon }) => {
            ...
            // Ajustar tamaño de imagen según presencia de redes sociales
            if (hasSocialLinks) {
                profileImage.classList.add('with-social');
            } else {
                profileImage.classList.remove('with-social');
