...
class GetExtendedContactDetailsStatistics implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'unsubscriptions' => 'simplerest\libs\SendinBlue\Client\Model\GetExtendedContactDetailsStatisticsUnsubscriptions',
        'opened' => 'simplerest\libs\SendinBlue\Client\Model\GetExtendedContactDetailsStatisticsOpened[]',
        'clicked' => 'simplerest\libs\SendinBlue\Client\Model\GetExtendedContactDetailsStatisticsClicked[]',
        'transacAttributes' => 'object[]',
        'delivered' => 'simplerest\libs\SendinBlue\Client\Model\GetExtendedContactDetailsStatisticsDelivered[]'
    ];
     ...
     * Sets messagesSent
     *
     * @param simplerest\libs\SendinBlue\Client\Model\GetExtendedContactDetailsStatisticsMessagesSent[] $messagesSent Listing of the sent campaign for the contact
     *
     * @return $this
     */
     ...
     * Sets hardBounces
     *
     * @param simplerest\libs\SendinBlue\Client\Model\GetExtendedContactDetailsStatisticsMessagesSent[] $hardBounces Listing of the hardbounes generated by the contact
     *
     * @return $this
     */
     ...
     * Sets softBounces
     *
     * @param simplerest\libs\SendinBlue\Client\Model\GetExtendedContactDetailsStatisticsMessagesSent[] $softBounces Listing of the softbounes generated by the contact
     *
     * @return $this
     */
     ...
     * Sets complaints
     *
     * @param simplerest\libs\SendinBlue\Client\Model\GetExtendedContactDetailsStatisticsMessagesSent[] $complaints Listing of the complaints generated by the contact
     *
     * @return $this
     */
     ...
     *
     * @return simplerest\libs\SendinBlue\Client\Model\GetExtendedContactDetailsStatisticsUnsubscriptions
     */
     ...
     *
     * @param simplerest\libs\SendinBlue\Client\Model\GetExtendedContactDetailsStatisticsUnsubscriptions $unsubscriptions unsubscriptions
     *
     * @return $this
     */
     ...
     * Gets opened
     *
     * @return simplerest\libs\SendinBlue\Client\Model\GetExtendedContactDetailsStatisticsOpened[]
     */
     ...
     * Sets opened
     *
     * @param simplerest\libs\SendinBlue\Client\Model\GetExtendedContactDetailsStatisticsOpened[] $opened Listing of the openings generated by the contact
     *
     * @return $this
     */
     ...
     * Gets clicked
     *
     * @return simplerest\libs\SendinBlue\Client\Model\GetExtendedContactDetailsStatisticsClicked[]
     */
     ...
     * Sets clicked
     *
     * @param simplerest\libs\SendinBlue\Client\Model\GetExtendedContactDetailsStatisticsClicked[] $clicked Listing of the clicks generated by the contact
     *
     * @return $this
     */
     ...
     * Gets delivered
     *
     * @return simplerest\libs\SendinBlue\Client\Model\GetExtendedContactDetailsStatisticsDelivered[]
     */
     ...
     * Sets delivered
     *
     * @param simplerest\libs\SendinBlue\Client\Model\GetExtendedContactDetailsStatisticsDelivered[] $delivered Listing of the delivered campaign for the contact
     *
     * @return $this
     */
