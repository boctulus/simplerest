...
?>
    ...
    */
    ...
    /*
        http://simplerest.lan/dumb/signature_remaining
    */
    function signature_remaining(){
        header('Content-Type: application/json', true, 400);

        return [
            "partner_name"  => "javierPrueba",
            "partner_email" => "javier.aliaga@haulmer.com",
            "remaining"     => 19
        ];
    }

    function test_curl_conversion_2(){        
        $curlCommand = <<<CMD
        curl --location 'http://simplerest.lan/dumb/signature_remaining' \
        --header 'apikey: a3b97b7b529447f1b1f09a3331da8e01'
        CMD;
    ...
    function test_inflector(){
        $inflector = InflectorFactory::create()->build();

        dd($inflector->singularize('cars')); // "car"
        dd($inflector->pluralize('category')); // "categories"
    }
    ...
    function test_custom_tags(){                
        ...
        // Ejemplo de uso:
        // Registro de un callback para el tag "calc".
        CustomTags::register('calc', function($params) {
            // Ejemplo: se espera que 'op' tenga una lista de números entre paréntesis, separados por comas.
            // Se procesa la operación según el parámetro "operation".
            $op = $params['op'];
            // Elimina paréntesis y espacios.
            $op = trim($op, '()');
            $numbers = array_map('trim', explode(',', $op));
            ...
            switch ($params['operation']) {
                ...
                case 'div':
                    ...
                    $result = (count($numbers) >= 2) ? $numbers[0] / $numbers[1] : null;
                    break;
                // Se pueden agregar más operaciones según sea necesario.
                default:
                    $result = null;
                    break;
            }
        ...
        // Registro de un callback para el tag "dir".
    ...
    function test_android_render_1(){
        $project_path = 'C:\Users\jayso\StudioProjects\DarkCalc'; 
        $view_path    = 'keyboard'; // app\src\main\res\layout\keyboard.xml
