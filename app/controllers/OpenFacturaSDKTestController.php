...
class OpenFacturaSDKTestController extends Controller
{
    ...
    private $api_key = '928e15a2d14d4a6292345f04960f4bd3';
    ...
    public function testEmitirDTE(){
        ...
        $response = $this->sdk_instance->emitirDTE($dteData, $responseOptions, null, null, $idempotencyKey);
    ...
    public function testAnularDTE52($folio = 12345, $fecha = '2023-01-01'){
        $response = $this->sdk_instance->anularDTE52($folio, $fecha);
