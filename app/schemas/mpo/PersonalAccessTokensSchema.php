...
{ 
	static function get(){
		return [
			...
			'fields'		=> ['id', 'tokenable_type', 'tokenable_id', 'name', 'token', 'abilities', 'last_used_at', 'expires_at', 'created_at', 'updated_at'],
			...
			'nullable'		=> ['id', 'abilities', 'last_used_at', 'expires_at', 'created_at', 'updated_at'],
