...
{ 
	static function get(){
		return [
			...
			'fields'		=> ['ID_OCM', 'OCM_NOMBRE', 'OCM_FECHA_APLICACION', 'OCM_ZONA', 'OCM_COMUNA_CORREGIMIENTO', 'OCM_DIRECCION', 'DEPARTAMENTO_ID', 'SUBREGION_ID', 'MUNICIPIO_ID', 'REPRESENTANTE_LEGAL_ID', 'TIPO_ORGANISMO_ORG_COMUNAL_ID', 'ESTADO_SEGUIMIENTO_ID', 'OCM_INSTITUCION_AVALANTE', 'SECTOR_ACTIVIDAD_ORG_COMUNAL_ID', 'OCM_OBJETIVO_SOCIAL', 'CERTIFICACION_QUE_EMITE_ORG_COMUNAL_ID', 'OCM_AREAS_TEMATICAS', 'OCM_FORTALEZAS_ORGANIZACION', 'OCM_REDES', 'OCM_TIENE_ESTATUTOS', 'OCM_REGISTRADA_CAMARA_COM', 'OCM_NUM_RADICADO_CAMARA_COM', 'OCM_PORC_CUMPL_PLAN_ULT_ANNO', 'OCM_PLAN_DE_TRABAJO', 'OCM_PLAN_DE_TRABAJO_PLA_PUB', 'OCM_PLAN_DE_TRABAJO_POL_PUB', 'INSTRUMENTO_PLANEACION_ID', 'OCM_RECURSOS_ECONOMICOS', 'OCM_FUENTES_FINANCIACION', 'OCM_PRESPUESTO_ANUAL', 'OCM_RECURSOS_PROPIOS', 'OCM_PROYECTOS_EJECUTADOS_REC_PROPIOS', 'OCM_PROYECTOS_EJECUTADOS_REC_PUBLICOS', 'OCM_PROYECTOS_EJECUTADOS_COOPERACION', 'OCM_REGISTRO_INGRESOS_Y_GASTOS', 'OCM_OBLIGACIONES_TRIBUTARIAS', 'OCM_CONTADOR', 'OCM_ACTIVIDADES_CONJUNTAS_PRIVADAS', 'OCM_ACTIVIDADES_CONJUNTAS_PUBLICAS', 'OCM_ACTIVIDADES_CONJUNTAS_OTRAS_ORG', 'ESCALA_TERRITORIAL_ID', 'OCM_MEDIOS_PROMOCION', 'OCM_LINK_CANAL_EMISORA', 'OCM_RENDICION_CUENTAS', 'OCM_ULTIMA_REND_CUENTA', 'OCM_ACCIONES_CONTROL_SOCIAL', 'OCM_NECESIDADES_ASESORIA', 'OCM_PUNTUACION', 'NIVEL_ID', 'OCM_BORRADO', 'created_at', 'updated_at'],
			...
			'required'		=> ['OCM_NOMBRE', 'OCM_FECHA_APLICACION', 'OCM_COMUNA_CORREGIMIENTO', 'OCM_DIRECCION', 'DEPARTAMENTO_ID', 'SUBREGION_ID', 'MUNICIPIO_ID', 'REPRESENTANTE_LEGAL_ID', 'TIPO_ORGANISMO_ORG_COMUNAL_ID', 'ESTADO_SEGUIMIENTO_ID', 'SECTOR_ACTIVIDAD_ORG_COMUNAL_ID', 'OCM_OBJETIVO_SOCIAL', 'CERTIFICACION_QUE_EMITE_ORG_COMUNAL_ID', 'OCM_AREAS_TEMATICAS', 'OCM_FORTALEZAS_ORGANIZACION', 'OCM_TIENE_ESTATUTOS', 'OCM_REGISTRADA_CAMARA_COM', 'OCM_PORC_CUMPL_PLAN_ULT_ANNO', 'OCM_PLAN_DE_TRABAJO', 'OCM_PLAN_DE_TRABAJO_PLA_PUB', 'OCM_PLAN_DE_TRABAJO_POL_PUB', 'INSTRUMENTO_PLANEACION_ID', 'OCM_PRESPUESTO_ANUAL', 'OCM_RECURSOS_PROPIOS', 'OCM_REGISTRO_INGRESOS_Y_GASTOS', 'OCM_OBLIGACIONES_TRIBUTARIAS', 'OCM_CONTADOR', 'ESCALA_TERRITORIAL_ID', 'OCM_MEDIOS_PROMOCION', 'OCM_RENDICION_CUENTAS', 'OCM_ULTIMA_REND_CUENTA', 'OCM_PUNTUACION', 'NIVEL_ID'],
			...
			'rules' 		=> [
				...
				'OCM_DIRECCION' => ['type' => 'str', 'max' => 255, 'required' => true],
			...
			'fks' 			=> ['DEPARTAMENTO_ID', 'CERTIFICACION_QUE_EMITE_ORG_COMUNAL_ID', 'ESTADO_SEGUIMIENTO_ID', 'ESCALA_TERRITORIAL_ID', 'INSTRUMENTO_PLANEACION_ID', 'NIVEL_ID', 'REPRESENTANTE_LEGAL_ID', 'SECTOR_ACTIVIDAD_ORG_COMUNAL_ID', 'SUBREGION_ID', 'TIPO_ORGANISMO_ORG_COMUNAL_ID', 'MUNICIPIO_ID'],
