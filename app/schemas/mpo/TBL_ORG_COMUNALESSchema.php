...
{ 
	static function get(){
		return [
			...
			'fks' 			=> ['BARRIO_ID', 'DEPARTAMENTO_ID', 'CERTIFICACION_QUE_EMITE_ORG_COMUNAL_ID', 'ESTADO_PERSON_JURID', 'ESTADO_SEGUIMIENTO_ID', 'ESCALA_TERRITORIAL_ID', 'GRUPO_INTERES', 'INSTRUMENTO_PLANEACION_ID', 'NIVEL_ID', 'PR_EJ_COOP_ID', 'PR_EJ_REC_PUB_ID', 'PR_EJ_REC_PROP_ID', 'REPRESENTANTE_LEGAL_ID', 'SECTOR_ACTIVIDAD_ORG_COMUNAL_ID', 'SUBREGION_ID', 'TIPO_ORGANISMO_ORG_COMUNAL_ID', 'MUNICIPIO_ID'],
			...
			'relationships' => [
				...
				'TBL_PROYECTOS_EJECUTADOS_COOPERACION' => [
					['TBL_PROYECTOS_EJECUTADOS_COOPERACION.ID_PCO','TBL_ORG_COMUNALES.PR_EJ_COOP_ID']
				],
				'TBL_PROYECTOS_EJECUTADOS_RECUR_PUBLICOS' => [
					['TBL_PROYECTOS_EJECUTADOS_RECUR_PUBLICOS.ID_PRB','TBL_ORG_COMUNALES.PR_EJ_REC_PUB_ID']
				],
				'TBL_PROYECTOS_EJECUTADOS_RECUR_PROPIOS' => [
					['TBL_PROYECTOS_EJECUTADOS_RECUR_PROPIOS.ID_PRV','TBL_ORG_COMUNALES.PR_EJ_REC_PROP_ID']
				],
