...
class ProductsSchema implements ISchema
{
    static function get(){
        return [
            ...
            'attr_types'        => [
                'id' => 'INT', 'name' => 'STR', 'type' => 'STR', 'regular_price' => 'STR', 'sale_price' => 'STR',
                'description' => 'STR', 'short_description' => 'STR', 'slug' => 'STR', 'images' => 'STR',
                'categories' => 'STR', 'tags' => 'STR', 'dimensions' => 'STR', 'attributes' => 'STR',
                'sku' => 'STR', 'status' => 'STR', 'stock' => 'INT', 'stock_status' => 'STR', 'url_ori' => 'STR',
                'posted' => 'INT', 'comment' => 'STR', 'created_at' => 'STR', 'updated_at' => 'STR',
                'cost' => 'STR', 'size' => 'STR', 'belongs_to' => 'INT', 'active' => 'INT', 'locked' => 'INT',
                'workspace' => 'STR', 'deleted_at' => 'STR'
            ],
            'attr_type_detail'  => [],
            'primary'           => ['id'],
            'autoincrement'     => 'id',
