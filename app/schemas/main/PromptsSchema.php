...
{ 
	static function get(){
		return [
			...
			'nullable'			=> ['id', 'project', 'notes', 'updated_at'],

			'required'			=> ['title', 'description', 'base_path', 'files', 'created_at'],

			'uniques'			=> [],

			'rules' 			=> [
				'id' => ['type' => 'int'],
				'title' => ['type' => 'str', 'max' => 100, 'required' => true],
				'project' => ['type' => 'int'],
				'description' => ['type' => 'str', 'required' => true],
				'base_path' => ['type' => 'str', 'max' => 100, 'required' => true],
