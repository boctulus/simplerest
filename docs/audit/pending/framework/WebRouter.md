...
> **Legacy disposition:** retained under `docs/audit/pending/`, not a current usage guide. Compilation specificity and resolver flow are summarized in [request lifecycle](../../../core/request-lifecycle.md); registration, groups, wildcard, and constraint examples remain pending source and runtime review. See the [claim-level audit](../../README.md#claim-level-findings-routing-and-request-lifecycle).
