...
> **Audit status:** Quarantined comparison material. Feature-parity rows have not been audited independently against both projects. The memory, latency, throughput, and 5–10x figures have no reproducible benchmark procedure and are rejected as current measurements. See the [claim-level audit](../../README.md#claim-level-findings-query-builder).
