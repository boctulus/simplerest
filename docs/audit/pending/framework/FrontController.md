...
> **Legacy disposition:** retained under `docs/audit/pending/`, not a current pipeline specification. The conditional handler flow is summarized in [request lifecycle](../../../core/request-lifecycle.md); customization and other behavior claims remain pending. See the [claim-level audit](../../README.md#claim-level-findings-routing-and-request-lifecycle).
