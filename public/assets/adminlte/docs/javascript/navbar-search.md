...
Activate the plugin by adding the following data-attribue `data-bs-widget="navbar-search"` to the `.navbar-search-block` inside the header. You can use the HTML Markup below for a quick start.
...
```js
("[data-bs-widget="navbar-search"]").SiteSearch(options)
```

##### HTML Markup
Place this HTML Markup after inside the header.
```html
<a data-bs-widget="navbar-search" href="#" role="button">
  ...
  <form class="form-inline">
    <div class="input-group input-group-sm">
      ...
      <div class="input-group-append">
        ...
        <button class="btn btn-navbar" type="button" data-bs-widget="navbar-search">
...
```html
<li class="nav-item">
  <a class="nav-link" data-bs-widget="navbar-search" href="#" role="button">
    <i class="fas fa-search"></i>
  </a>
  <div class="navbar-search-block">
    <form class="form-inline">
...
Example: `$('[data-bs-widget="navbar-search"]').SiteSearch('toggle')`
