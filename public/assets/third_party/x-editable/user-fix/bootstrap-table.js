	...
	*/
	...
	var CONSTANTS = {
	  ...
	  5: {
	    iconsPrefix: 'mdi',
	    icons: {
	      paginationSwitchDown: 'mdi-menu-down',
	      paginationSwitchUp: 'mdi-menu-up',
	      refresh: 'mdi-sync',
	...
	var DEFAULTS = {
	  ...
	  onPreToolbarInit: function() {
	  	return false;
	  },
	  onPostToolbarInit: function() {
	  	return false;
	  },
	  ...
	  onPreInsertRow: function onPreInsertRow() {
	  	return false;
	  },
	  onPostInsertRow: function onPostInsertRow() {
	  	return false;
	  },
	  onPreRemoveRow: function onPreRemoveRow() {
	  	return false;
	  },
	  onPostRemoveRow: function onPostRemoveRow() {
	  	return false;
	  },
	  onPreRemoveAll: function onPreRemoveAll() {
	  	return false;
	  },
	  onPostRemoveAll: function onPostRemoveAll() {
	  	return false;
	  },
	};
	var EN = {
	...
	var EVENTS = {
	  ...
	  'pre-toolbar-init.bs.table': 'onPreToolbarInit',
	  'post-toolbar-init.bs.table': 'onPostToolbarInit',
	  'pre-insert-row.bs.table': 'onPreInsertRow',
	  'post-insert-row.bs.table': 'onPostInsertRow',
	  'pre-remove-row.bs.table': 'onPreRemoveRow',
	  'post-remove-row.bs.table': 'onPostRemoveRow',
	  'pre-remove-all.bs.table': 'onPreRemoveAll',
	  'post-remove-all.bs.table': 'onPostRemoveAll',
	};
	  ...
	  _createClass(BootstrapTable, [{
	    ...
	    value: function initContainer() {
	      ...
	      if (this.options.buttonsToolbar) {
	      	// Account for the user providing the toolbar container; the table might not be in the document yet
	        this.$toolbar = ((this.options.buttonsToolbar instanceof $) ? this.options.buttonsToolbar : $__default['default']('body').find(this.options.buttonsToolbar));
	      } else {
	    ...
	    value: function initToolbar() {
	      ...
	      this.trigger('pre-toolbar-init', this.$toolbar); // Notify the user in case they need to remove things they moved around
	      ...
	      this.trigger('post-toolbar-init', this.$toolbar); // Notify the user in case they need to move the toolbar menus to a better DOM layer
	    }
	  }, {
	    key: "onSearch",
	    ...
	    value: function trigger(_name) {
	      ...
	      var event = $__default['default'].Event(name, { sender: this });
	    ...
	    value: function fitHeader() {
	      ...
	      $tr.find('> *').each(function (i, el) {
	        ...
	        $th.find('.fht-cell').css((!_this14.options.checkboxHeader && $th.hasClass("bs-checkbox")) ? "minWidth" : "width", $this.innerWidth() - zoomWidth);
	      });
	    ...
	    value: function horizontalScroll() {
	      ...
	      this.$tableHeader.off('scroll').on('scroll', function () {
	        var scrollLeft = _this16.$tableHeader.scrollLeft();

	        _this16.$tableBody.scrollLeft(scrollLeft);
	    ...
	    value: function refreshOptions(options) {
	      ...
	      this.trigger('refresh-options', this.options, options);
	      this.destroy();
	      this.init();
	    }
	  }, {
	    ...
	    value: function remove(params) {
	      var event = this.trigger('pre-remove-row', params);
	      ...
	      this.initSort();
	      this.initBody(true);
	      this.trigger('post-remove-row', params, removed);
	    }
	  }, {
	    key: "removeAll",
	    value: function removeAll() {
	      if (this.options.data.length > 0) {
	      	var event = this.trigger('pre-remove-all', this.options.data.length);
	        if (event.isDefaultPrevented()) {
	        	return;
	        }
	    ...
	    value: function insertRow(params) {
	      ...
	      var event = this.trigger('pre-insert-row', params);
	      if (event.isDefaultPrevented()) {
	      	return;
	      }
	      ...
	      this.initSort();
	      this.initBody(true);
	      this.trigger('post-insert-row', params);
	    }
	  }, {
	    key: "updateRow",
	    ...
	    value: function resetView(params) {
	      ...
	      if (this.options.cardView) {
	        ...
	        this.getCaret();
	        // this.$tableContainer.css('padding-bottom', "".concat(padding, "px")); // This can be fixed with CSS
	      }
	    ...
	    value: function updateFormatText(formatName, text) {
	      ...
	      console.log("bs.updateFormatText");
	      this.initToolbar();
	      this.initPagination();
	      this.initBody();
	    }
